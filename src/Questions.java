...
public class Questions {
	...
	public static int Quest2(){
		...
		//Given input
		String input = ">>v>^v<><<>>>^^^^v>v<>v>><>^>>^vv^^>^><<<vv^<>v>>>^v<v<<v<^vv>>>^^><v>^vv^<v><vv><<^v<<<^^>v><^v>>><v>><><<vvv>>><<>>v>^<><>^vv<>>^^^>^^>>><v^v^^^^<<>^v^^vvv><>>>^^^><^><^>^v<>>v<v>^v<^>^^v^<<v>^>vv>v<v>v^<vv>^^^v<<<v^>^<v>><<^>v<vvvv>v^^<<vv>>^^v<^^<<<<<^^><^v^><<<^^<^>^v<vv<<v>^^<v^v>^vvv<^^<v<>>v>^><^v<^v^^v<v<^v<<>vvv^<^>^^v^^^>><v><>v><^v<>^>^v^<<v>vv>>>^><v><^>^<>^>><vv>^><v^^v>>>><v^^v<>v>v^>>v<<v>v^>>v^<<^^v^>v^vvvv>^^>vv^<<>^>^<^>><<<<v<v<>>>><v>>>><<^^><vv^>>^v^^<<vv^>>v^>>>vv>>^v^>>>^>^v<>^^^>v><>^^vv<^<^^<vv^v^<vvv>>v>^^<^^<>v>>v<^v<v<^<<^v<>>>^>^v<>v<>v^><<^^<vvv>v<v^v<<v><<><v^>>>><v^>^^v><v<>^<><v>^^>v^<<vv^>vv<^<<>vv<<>^>>^<<v><v>^>^^<>><vv<vv>^vv^>v^<v>^v>^>^>^<v<^<v^<<v^><^>v^v>vv<<^v^<<>^v<<^^v<>v^><<<v<><vvv<v^<<>>>>vv<^>v<>^>^^^<><<v^<^v<<^<<^>>^<<^>>v>v<<<v^^><<>^^vv^<><^v<^<>vvvv<^^>>v<>^vvv>v><^<^v^<<<<<>>v>v<^v>><<vvv^vv>^<>v^<^v^^<^v<>>>><>^v^v^v><v^<>v^><^<>v^^^<>>^^<^>^<<^^<vv>><v><>vv>><<><<>^<vv^^>^v<vv<v^v>>>>^^v<^^<v>v><<<<^^>^>v<>>^v>v><<v^<<<vv<vv^^<><<<>>vv>>v<>^<<<<vv<^<v<^^<^><<v^<<v><v<<<>><vv>>v^v^v><<>^^<vv>^^>>v<v<^>^vv>^<v<><^vvv>^^><v^v>v^>v<v>^v<><^^^v>^v<<v^>^<^v^v<>^v^^>^>>>^>>^<>^<^vv^^>>>>^<v^v^<v>>v><<<^v<^<<v>><v^^><^<^v^<><v^><v><>^v^>^v>v>v<<v>>v>v>>v<<>>>^^>>v><^^^^<^<<^^^>^>><v>^>><^<v><^><v<<^v>v>v<v><<><v>>^>>>><v><v^<v><^<>^<^^><<>><v^^<v>>vv^^^vvvvv>>><vvv^^<v^<<v>v^vv<vv><v<v<<v<<^><^v^<^^v<v<>v<<>v<>v<>^vvv>>>v>vv<vv<^<<<<<>>>^^>v^<>v^<><v^^>v^^^<vv>^<v<>>>^^v>^<<v>vv>^<^>^^<>^v^>^v>v<>^><^v^>v<v>>v<<v<<>^>>>>vv><<v<^v^^>^<>^^>^v>^v><<vv>>^^>^^vv^>^v^v<v<^^<v<>^<<<^v<^v>>^^vv>v<<><vvvv^<>>v<^^>>>v<<>v^v>v^v<>^<<^v^vvv<^<>^v>^^<^vvv>>^>>^>v^^v^v^^><>v>^^>^^v^<<^v<>^^<<>^<^<<^<><<v>vv<v><>v>^^<<>>>v<^<^^^<v<vvvvv^<>>v><^>v<><<^><><<vv<><v<><v>^^<>^^<^>>v>>^^v<v^<>>v>>^^><><^v^<>>>v>>v^<<v>>v^v<^v<vv^^v^^vv<v<v^v>><><^v^^>v>^><>^>v^v<<v>v><>>><<vv<>><<v<<<v>>^>><>v^^^<^v^^v><v<^<>v^v<>v><v><^v<vvvv><><><<>>^vv^<v>v";
		int inputLen = input.length();
